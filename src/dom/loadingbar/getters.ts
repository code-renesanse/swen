// TODO: refactor this so that it is not hardcored as a string
// TODO: implement a way to reference a loading bar gif dynamicaly (meaning so that the loading bar gif can be defined in the constructor of the application)
/**
 *
